...
function OrderComplete({ completeMessage }) {
  ...
  return (
    <Wrapper>
      ...
      <ButtonWrapper>
        <CommonButton buttonTitle="주문 내역 확인" borderColor="#9E8CEC" width="239px" margin="47px 0 0 0" borderRadius="20px" onClick={handleLookUp} />
        <CommonButton buttonTitle="메인페이지로 이동" width="239px" margin="47px 0 0 68px" borderRadius="20px" onClick={handleMain} />
      </ButtonWrapper>
    </Wrapper>
