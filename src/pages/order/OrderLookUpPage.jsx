      ...
      <OrderInfoTable>
        ...
        {orderInfo.map((obj) => (
          <OrderInfoTr>
            ...
            <OrderInfoTd>
              <CommonButton buttonTitle="취소" width="68px" height="35px" borderRadius="20px" borderColor="#9E8CEC" onClick={handleCancel} />
              <CommonButton buttonTitle="수정" width="68px" height="35px" borderRadius="20px" margin=" 0 0 0 14px" onClick={handleModify} />
            </OrderInfoTd>
          </OrderInfoTr>
        ))}
      </OrderInfoTable>
